...
public class MainActivity extends AppCompatActivity {
    ...
    class CellListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (!isValidMove(row, col)) {
                Toast.makeText(MainActivity.this, "call is already", Toast.LENGTH_LONG).show();
                return;
            ...
            if (gameEnded(row, col) == -1) {
                ...
                Toast.makeText(MainActivity.this, "it is  a drow", Toast.LENGTH_LONG).show();
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        outState.putBoolean("player1Turn", player1Ture);
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        player1Ture = savedInstanceState.getBoolean("player1Ture");
        byte[] boardsingal = savedInstanceState.getByteArray("board");
        for (int i = 0; i < 9; i++) {
            board[i / 3][i % 3] = boardsingal[i];
